...
class CoverGenerator {
  ...
  static Future<String> saveCover(
    ...
    try {
      ...
      // 生成唯一的封面文件名
      final coverFileName = '${basenameWithoutExtension(bookFileName)}_${DateTime.now().millisecondsSinceEpoch}.png';
  ...
  /// 绘制格式标签
  static void _drawFormatTag(Canvas canvas, Size size, String format, Color color) {
