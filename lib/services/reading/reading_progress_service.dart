...
class ReadingProgressService {
  ...
  Future<void> _saveCriticalProgress() async {
    final criticalProgress =
        _progressCache.values.where((progress) => progress.isCritical).toList();
  ...
  Map<String, dynamic> getCacheStats() {
    ...
    final criticalCached =
        _progressCache.values.where((progress) => progress.isCritical).length;
