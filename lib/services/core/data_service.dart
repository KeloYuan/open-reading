...
import 'package:xxread/services/reading/reading_progress_service.dart';
...
class DataManager {
  ...
  ReadingProgressService get progressService => _progressService;
  ...
  Map<String, dynamic> getStats() {
    return {
      ...
      'progress_service_stats': {
        // Progress service statistics would be added here when available
      },
