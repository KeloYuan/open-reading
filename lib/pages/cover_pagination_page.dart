...
/// 覆盖翻页视图
/// 实现新页面从侧面覆盖当前页的效果
class CoverPaginationPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CoverPaginationPage> createState() =>
      _CoverPaginationPageState();
}

class _CoverPaginationPageState extends ConsumerState<CoverPaginationPage> {
  int _currentPage = 0;
